    ...
    <div className="flex flex-col h-full justify-center items-center">
      <div className="flex flex-col w-[560px] p-10 shadow-md   gap-6 ">
        ...
        <ul className='flex flex-col gap-2'>
         ...
         {clearb&&<button  onClick={()=>{
          clearAll()
          setclearb(false)
          
        }} className='tracking-[0.25rem] text-[14px] text-red-400 hover:text-red-600 hover:transition-all'>Clear Items</button>}
      </div>
    </div>
  );
}
